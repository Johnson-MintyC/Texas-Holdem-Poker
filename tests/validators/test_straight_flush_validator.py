...
class StraightFlushValidatorTest(unittest.TestCase):
    def test_determines_that_there_are_not_five_consec_same_suit(self):
        cards = [
    ...
    def test_determines_that_there_are_five_consec_same_suit(self):
        cards = [
            Card(rank = "3", suit = "Clubs"),
            Card(rank = "4", suit = "Clubs"),
            Card(rank = "5", suit = "Clubs"),
    ...
    def test_determines_flush_five_consec_same_suit(self):
